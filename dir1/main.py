...
def save_files(uploaded_file, save_directory):
...
def page_file_uploader():
    ...
    uploaded_file = st.file_uploader("Upload Files", type=["pdf", "jpg", "txt"])
    ...
    if uploaded_file and save_directory:
        save_files(uploaded_file, save_directory)
        
    jsonobj = text_extract(save_directory, uploaded_file)
    
    if jsonobj["filetype"]:
        save_files(uploaded_file=uploaded_file, save_directory=jsonobj["filetype"])
